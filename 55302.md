...
<p class="block_"><img alt="Image" class="calibre4" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-12.png"/></p>
...
<li class="block_15">For the option <i class="calibre7">Item Version History</i> change the option for <i class="calibre7">Create a version each time you edit an item in this list?</i> To <b class="calibre6">Yes</b><br class="calibre2"/> </li>
...
<li class="block_15">Choose <b class="calibre6">Column settings </b>&gt; <b class="calibre6">Rename</b><br class="calibre2"/> </li>
...
<li class="block_26">Application date: <b class="calibre6">Today</b></li>
...
<p class="block_27"><img alt="Image" class="calibre55" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image52.png"/></p>
<ol class="list_">
...
<li class="block_15">In the <i class="calibre7">Grant access</i> menu, click on the <b class="calibre6">ellipsis (…)</b> and choose <b class="calibre6">Manage access</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre59" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image55.png"/><br class="calibre2"/> </li>
...
<li class="block_15">Choose the option <b class="calibre6">From Excel</b> which is in the left margin<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre62" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image58.png"/><br class="calibre2"/> </li>
...
<li class="block_15">Save to the <b class="calibre6">Marketing</b> site<br class="calibre2"/><img alt="Image" class="calibre64" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image60.png"/><br class="calibre2"/> </li>
...
<li class="block_15">In the <i class="calibre7">Formula</i> box enter: <b class="calibre6">=[Salary]/12-([Salary]/12*0.2)<br class="calibre2"/></b><br class="calibre2"/><img alt="Image" class="calibre84" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image79.png"/><br class="calibre2"/> </li>
...
<li class="block_15">Select the list named <b class="calibre6">Job applications</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre91" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image84.png"/><br class="calibre2"/> </li>
...
<li class="block_15">In the formula box enter: <b class="calibre6">=if([$Progress]=='Active','true', 'false')</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre94" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image87.png"/><br class="calibre2"/> </li>
<li class="block_15">At the bottom of the form click <b class="calibre6">Save</b><br class="calibre2"/> </li>
...
<li class="block_25">Click on the <b class="calibre6">Microsoft Lists</b> button to the right of the <b class="calibre6">app launcher </b><img alt="Image" class="calibre25" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image.jpeg"/></li>
</ol>
...
===
[Home](#home)
# Exercise 2 - Design a form using Power Apps
<p class="block_">Ravinder is happy with the changes we have make to the job application list and has started adding new applicants. We will now turn our attention to the feedback we have received regarding the IT Salaries Campaign list. The feedback regarding the form for this list is whether it can be improved visually. Visual improvements are beyond the scope of the form editor within Microsoft Lists and requires us to use Power Apps.</p>
<ol class="list_">
<li class="block_14">On the Microsoft Lists home page, select the list named <b class="calibre6">IT Salaries Campaign</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre97" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image90.png"/><br class="calibre2"/> </li>
<li class="block_15">In the ribbon, with no items selected, choose <b class="calibre6">Integrate</b> &gt; <b class="calibre6">Power Apps </b>&gt; <b class="calibre6">Customize forms</b><br class="calibre2"/><br class="calibre2"/><img alt="Graphical user interface, application  Description automatically generated" class="calibre98" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-31.png"/><br class="calibre2"/> </li>
<li class="block_15">Allow Power Apps a few seconds to prepare<br class="calibre2"/> </li>
<li class="block_15">On the <i class="calibre7">Welcome to Power Apps Studio</i> message, click <b class="calibre6">Skip</b><br class="calibre2"/> </li>
<li class="block_15">If you see another message about your country/region, select your country and click <b class="calibre6">Get started</b><br class="calibre2"/> </li>
<li class="block_15">The studio starts with the <i class="calibre7">Fields</i> pane expanded, here we can modify and remove some fields, for example the <i class="calibre7">Monthly Salary </i>field, hover your mouse over this field and click on the <b class="calibre6">ellipsis (…)</b> then choose <b class="calibre6">Remove</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre99" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-32.png"/></li>
<li class="block_15">Click on the <b class="calibre6">X</b> to close the <i class="calibre7">Fields </i>menu<br class="calibre2"/> </li>
<li class="block_15">Next to change the theme, ensure that the <i class="calibre7">Home</i> tab is selected in the ribbon then select <b class="calibre6">Theme</b> (this might be nested in the <img alt="Caret Down" class="calibre100" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-33.png"/> menu as shown below)<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre101" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-34.png"/><br class="calibre2"/> </li>
<li class="block_15">Select a theme you like, we recommend a choice from the <i class="calibre7">OFFICE</i> category as they are most aligned to the look and feel of Microsoft Lists, in our example we will use <b class="calibre6">Dark Yellow</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre102" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image96.png"/><br class="calibre2"/> </li>
<li class="block_15">Click away from the themes to close the menu<br class="calibre2"/> </li>
<li class="block_15">To add a logo to the form, click on the <b class="calibre6">Insert</b> tab in the ribbon, and select <b class="calibre6">Icons<br class="calibre2"/></b><br class="calibre2"/><img alt="Image" class="calibre103" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-35.png"/><br class="calibre2"/> </li>
<li class="block_15">From the icon selection choose an icon to place on the form, in our example we have added the <b class="calibre6">Money</b> icon<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre104" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image98.png"/><br class="calibre2"/> </li>
<li class="block_15">Press and hold your left mouse button down on the icon to drag it to the bottom of the form<br class="calibre2"/> </li>
<li class="block_15">With the icon selected use the resize handles to make the icon larger<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre105" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image99.png"/><br class="calibre2"/> </li>
<li class="block_15">If you would like to change the colour of the icon, with the icon selected click on the <b class="calibre6">Color</b> option in the properties pane on the right-side of the studio<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre106" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image100.png"/><br class="calibre2"/> </li>
<li class="block_25">We could make further changes to the form using Power Apps as discussed in our module, however we will leave the form with the customisations we have made</li>
</ol>
...
===
[Home](#home)
# Exercise 3 – Publish and test your form
<p class="block_">Now that the visual properties of the form have been updated, we will now publish our changes and test the form.</p>
<ol class="list_">
<li class="block_14">In Power Apps Studio, click on the <b class="calibre6">File</b> tab in the ribbon<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre107" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-36.png"/><br class="calibre2"/> </li>
<li class="block_15">Click <b class="calibre6">Save</b><br class="calibre2"/> </li>
<li class="block_15">Choose <b class="calibre6">Publish to SharePoint</b><br class="calibre2"/> </li>
<li class="block_15">In the pop-up menu, select <b class="calibre6">Publish to SharePoint</b> once more<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre108" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image102.png"/><br class="calibre2"/> </li>
<li class="block_15">At the top-left of the menu bar click on the <b class="calibre6">Back</b> arrow<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre109" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-37.png"/></li>
<li class="block_15">Below the <i class="calibre7">app launcher</i> select <b class="calibre6">Back to SharePoint </b>to exit the studio<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre110" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image104.png"/><br class="calibre2"/> </li>
<li class="block_15">To test your form, click on <b class="calibre6">+ New</b> in the ribbon and your custom form is displayed<br class="calibre2"/> </li>
<li class="block_25">Click <b class="calibre6">Cancel</b> at the top of the form to close it, then in the <b class="calibre6">app launcher</b> <img alt="Image" class="calibre25" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image.jpeg"/> select <b class="calibre6">Teams </b>then select <b class="calibre6">Use the web app instead</b> to set up our last lab</li>
</ol>
...
===
[Home](#home)
# Lab 5 – Setting up rules and designing flows
<p class="block_"><img alt="Image" class="calibre111" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-38.png"/></p>
<p class="block_">In our last lab we will be exploring the options for automated business processes within our lists. Like customising forms, there are different tools for adding automated business processes to a list depending on how customised the process needs to be. Simpler processes such as being notified when an item is deleted can be easily added using a rule. However, for a more bespoke process, such as being notified in Teams if one of your staff is booking time off with a choice to approve or reject and notify them by teams will require Power Automate. This is a workflow design tool, and we can build workflows, known simply as flows in Power Automate quite quickly by leveraging templates.</p>
...
===
[Home](#home)
# Exercise 1 – Set up team and add new list
<p class="block_">The marketing team has expressed an interest in having a holiday request booking system set up that uses Microsoft Teams as an interface for accessing the request system but also use its chat features to sent messages to the right audiences to gain approval and provide feedback. To do this we will quickly add a Team to our existing Marketing site and set up our list.</p>
<ol class="list_">
<li class="block_14">At the end of our previous exercise we left ourselves in Teams, please review the last step of the previous exercise if you are not in this location<br class="calibre2"/> </li>
<li class="block_15">At the bottom left of the page click <b class="calibre6">Join or create a team</b> (if you do not see this option, make sure that <b class="calibre6">Teams</b> is selected in the left navigation<br class="calibre2"/> </li>
<li class="block_15">Next, move your mouse cursor over <i class="calibre7">Create a team</i> and then click <b class="calibre6">Create team</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre112" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image106.png"/><br class="calibre2"/> </li>
<li class="block_15">Choose <b class="calibre6">Create from…</b><br class="calibre2"/> </li>
<li class="block_15">Choose <b class="calibre6">Microsoft 365 group</b><br class="calibre2"/> </li>
<li class="block_15">Click on <b class="calibre6">Marketing</b><br class="calibre2"/> </li>
<li class="block_15">Choose <b class="calibre6">Create</b><br class="calibre2"/> </li>
<li class="block_15">Click on the <b class="calibre6">ellipsis (…)</b> to the right of the marketing team<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre113" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-39.png"/></li>
<li class="block_15">Choose <b class="calibre6">Add channel</b><br class="calibre2"/> </li>
<li class="block_15">Name the channel <b class="calibre6">Holidays<br class="calibre2"/> </b></li>
<li class="block_15">Click<b class="calibre6"> Add</b><br class="calibre2"/> </li>
<li class="block_15">In the <i class="calibre7">Holidays</i> channel, click on the <b class="calibre6">+</b> to the right of the <i class="calibre7">Wiki</i> tab to add a tab<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre114" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image108.png"/><br class="calibre2"/> </li>
<li class="block_15">From the <i class="calibre7">Add a tab</i> menu choose <b class="calibre6">Lists</b><br class="calibre2"/> </li>
</ol>
<p class="block_27"><img alt="Image" class="calibre115" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image109.png"/><br class="calibre2"/> </p>
<ol class="list_">
<li class="block_15" value="14">Click <b class="calibre6">Save</b><br class="calibre2"/> </li>
<li class="block_15">Next choose <b class="calibre6">Create a list</b><br class="calibre2"/> </li>
<li class="block_15">Select <b class="calibre6">Blank list</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre116" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image110.png"/><br class="calibre2"/> </li>
<li class="block_15"><i class="calibre7">Name </i>the list <b class="calibre6">Holiday requests</b> and pick an icon<br class="calibre2"/> </li>
<li class="block_15">Once ready, click <b class="calibre6">Create</b><br class="calibre2"/> </li>
<li class="block_15">Using the <b class="calibre6">+ Add column</b> button, create the following columns<br class="calibre2"/> </li>
</ol>
<ol class="list_1">
<li class="block_26"><b class="calibre6">Multiple lines of text</b> column named <b class="calibre6">Description</b>, then click <b class="calibre6">Save<br class="calibre2"/> </b></li>
<li class="block_26"><b class="calibre6">Date and time </b>column named <b class="calibre6">Start date</b>, then click <b class="calibre6">Save</b><br class="calibre2"/> </li>
<li class="block_26"><b class="calibre6">Date and time </b>column named <b class="calibre6">End date</b>, then click <b class="calibre6">Save<br class="calibre2"/> </b></li>
<li class="block_26"><b class="calibre6">Person </b>column named <b class="calibre6">Line manager</b>, then click <b class="calibre6">Save</b><br class="calibre2"/> </li>
</ol>
<ol class="list_">
<li class="block_25" value="20">Your list is now ready</li>
</ol>
...
===
[Home](#home)
# Exercise 2 – Create a new rule
<p class="block_">Now that we have our list, we will look at enhancing it with some automated processes. Firstly, as the list owner you might be interested in knowing if any holiday requests have been removed from the list. We could set up an alert however it is faster to use the newer rule system which offers more choices than the older alert system.</p>
<ol class="list_">
<li class="block_14">Within the list in teams, click on the <b class="calibre6">ellipsis (…)</b> in the ribbon and choose <b class="calibre6">Open in SharePoint</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre117" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image111.png"/><br class="calibre2"/> </li>
<li class="block_15">A new tab will open offering us more options for managing the list than Teams offered, in the ribbon click on <b class="calibre6">Automate</b> (this may be hidden in an <b class="calibre6">ellipsis (…)</b> menu)<br class="calibre2"/> </li>
<li class="block_15">From the <i class="calibre7">Automate</i> menu choose<b class="calibre6"> Create a rule</b><br class="calibre2"/><br class="calibre2"/><img alt="A screenshot of a cell phone  Description automatically generated" class="calibre118" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-40.png"/></li>
</ol>
<p class="block_17"> </p>
<ol class="list_">
<li class="block_15" value="4">In the <i class="calibre7">Create a rule</i> menu, select a trigger that will be used to send your notification, for example, we wish to be notified if an item is deleted, so we can pick <b class="calibre6">An item is deleted</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre119" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-41.png"/></li>
<li class="block_15">Select <b class="calibre6">Enter a name or email address</b> and then enter your account name to send the notification to yourself<br class="calibre2"/><img alt="A picture containing bird, tree, flower  Description automatically generated" class="calibre120" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-42.png"/><br class="calibre2"/> </li>
<li class="block_21">Click <b class="calibre6">Create</b> to save and enable your rule<br class="calibre2"/> </li>
</ol>
<p class="block_28" id="calibre_pb_8"> </p>
...
===
[Home](#home)
# Exercise 3 – Test your rule
<p class="block_">To ensure the rule works as expected, we will test it by creating an item, then deleting it. We will then check our mailbox for the notification.</p>
<ol class="list_">
<li class="block_14">In the ribbon of the list click <b class="calibre6">+ New</b><br class="calibre2"/> </li>
<li class="block_15">In the <i class="calibre7">Title</i> field enter <b class="calibre6">Holiday Test</b><br class="calibre2"/> </li>
<li class="block_15">Click <b class="calibre6">Save</b><br class="calibre2"/> </li>
<li class="block_15"><b class="calibre6">Right-click</b> on the <i class="calibre7">Holiday Test</i> item and choose <b class="calibre6">Delete</b><br class="calibre2"/> </li>
<li class="block_15">Confirm by clicking <b class="calibre6">Delete</b><br class="calibre2"/> </li>
<li class="block_15">Click on the <b class="calibre6">app launcher</b> <img alt="Image" class="calibre25" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image.jpeg"/> and move your mouse cursor over <i class="calibre7">Outlook</i> to click the <b class="calibre6">ellipsis (…)</b> <br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre121" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image115.png"/><br class="calibre2"/> </li>
<li class="block_15">Choose the option <b class="calibre6">Open in new tab</b><br class="calibre2"/> </li>
<li class="block_15">In your mailbox check for the rule notification (this can take a couple of minutes)<br class="calibre2"/> </li>
<li class="block_15">Check over the email notification and then close the browser tab showing Outlook and return to the SharePoint browser tab<br class="calibre2"/><br class="calibre2"/>If you have not received your email yet and wish to continue, you can leave the Outlook tab open and check back later</li>
</ol>
<p class="block_29"> </p>
...
===
[Home](#home)
# Exercise 4 – Delete a rule
<p class="block_">You decide that the rule is no longer necessary. We will now remove the rule from the list.</p>
<ol class="list_">
<li class="block_14">In the browser tab that has your list open in SharePoint, in the ribbon click on <b class="calibre6">Automate</b> &gt; <b class="calibre6">Manage rules<br class="calibre2"/><br class="calibre2"/></b><img alt="Image" class="calibre122" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image116.png"/><b class="calibre6"><br class="calibre2"/> </b></li>
<li class="block_15">Click on the only available rule which we created earlier <br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre123" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image117.png"/><br class="calibre2"/> </li>
<li class="block_15">In the edit menu click on the option <b class="calibre6">Delete rule</b> and confirm<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre124" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-43.png"/><br class="calibre2"/> </li>
<li class="block_15">Click on the <b class="calibre6">X</b> to close the <i class="calibre7">Rules available</i> menu</li>
</ol>
<p class="block_29"> </p>
...
===
[Home](#home)
# Exercise 5 – Add a custom approval flow
<p class="block_">We will now introduce a more bespoke automated business process into our list. Although we will use a template to create most of it, we will also be swapping our a few actions to make the process more aligned to Teams rather than having it send emails.</p>
<ol class="list_">
<li class="block_14">In the browser tab that has your list open in SharePoint, in the ribbon click <b class="calibre6">Integrate</b> &gt; <b class="calibre6">Power Automate</b> &gt; <b class="calibre6">Create a flow</b><br class="calibre2"/> </li>
<li class="block_15">Choose the template titled <b class="calibre6">Start an approval when a new item is added</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre125" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image119.png"/><br class="calibre2"/> </li>
<li class="block_15">A new browser tab will open, if you are asked to select a country/region, make a selection and choose <b class="calibre6">Get started</b><br class="calibre2"/> </li>
<li class="block_15">At the bottom of the page, where it says <i class="calibre7">This flow will connect to</i> click <b class="calibre6">Continue</b><br class="calibre2"/> </li>
<li class="block_15">Below the search bar at the top of the page is the workflows name, currently it is <i class="calibre7">Start approval when a new item is added</i>, change this to <b class="calibre6">Start holiday approval in Teams</b><br class="calibre2"/> </li>
<li class="block_15">Click on the <b class="calibre6">ellipsis (…)</b> to the top-right of the <i class="calibre7">Start an approval</i> action<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre126" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image120.png"/><br class="calibre2"/> </li>
<li class="block_15">Select the option <b class="calibre6">Delete</b><br class="calibre2"/> </li>
<li class="block_15">When informed that this deletion will remove associated action and content click <b class="calibre6">OK</b><br class="calibre2"/> </li>
<li class="block_15">Using step 6 and 7, delete the following actions from the <i class="calibre7">If yes </i>and <i class="calibre7">If no</i> branches of the condition<br class="calibre2"/> </li>
</ol>
<ol class="list_1">
<li class="block_26">From the <i class="calibre7">If yes</i><span class="text_8"> </span>branch (green) delete <b class="calibre6">Inform item creator of approval</b><br class="calibre2"/> </li>
<li class="block_26">From the <i class="calibre7">If no</i> branch (red) delete <b class="calibre6">Inform item creator of rejection<br class="calibre2"/> </b></li>
</ol>
<ol class="list_">
<li class="block_15" value="10">The condition branches will now appear empty<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre127" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image121.png"/><br class="calibre2"/> </li>
<li class="block_15">We will now create a new approval request, using Teams chat, rather than an email, to do this position your mouse cursor on the black line below the trigger (top action) titled <i class="calibre7">When a new item is created</i><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre128" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-44.png"/><br class="calibre2"/> </li>
<li class="block_15">A <b class="calibre6">(+)</b> button appears allowing you to add an action, click this button and choose <b class="calibre6">Add an action</b><br class="calibre2"/> </li>
<li class="block_15">Search for <b class="calibre6">Teams Post</b><br class="calibre2"/> </li>
<li class="block_15">Choose the action titled <b class="calibre6">Post a choice of options as the Flow bot to a user</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre129" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image123.png"/><br class="calibre2"/> </li>
<li class="block_15">The action is added, and the Team service is connected, we will now configure the first option button in our post, within the action, in the field titled <i class="calibre7">Options Item – 1</i> enter <b class="calibre6">Approve holiday request</b><br class="calibre2"/> </li>
<li class="block_15">Click the <b class="calibre6">Add new item</b> button below <i class="calibre7">Options Item – 1</i><br class="calibre2"/> </li>
<li class="block_15">In the new field named <i class="calibre7">Options Item – 2</i> enter <b class="calibre6">Reject holiday request</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre130" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image124.png"/></li>
</ol>
<p class="block_17"> </p>
<ol class="list_">
<li class="block_15" value="18">Select the <i class="calibre7">Recipient </i>field to display the <i class="calibre7">Dynamic content</i> pane and in the <i class="calibre7">Search</i> box enter <b class="calibre6">Line manager</b><br class="calibre2"/> </li>
<li class="block_15">Select the property <b class="calibre6">Line manager Email<br class="calibre2"/> </b></li>
<li class="block_15">You have just used the dynamic content window to add a dynamic property, this property will be what ever line manager the user enters when they create a new holiday request in our list, very clever!<br class="calibre2"/> </li>
<li class="block_15">Next click into the <i class="calibre7">Message</i> field, using both normal text and dynamic content, create the message below (note that <i class="calibre7">Created by Dis…</i> is <i class="calibre7">DisplayName</i>)<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre131" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image125.png"/><br class="calibre2"/> </li>
<li class="block_15"> In the <i class="calibre7">Headline</i> field enter, <b class="calibre6">There is a new holiday request from your team</b><br class="calibre2"/> </li>
<li class="block_15">Great work, with these references, the line manager will be well informed, now let us update the condition action with the outcome from the line manager<br class="calibre2"/> </li>
<li class="block_15">Click on the <b class="calibre6">Condition </b>action so that it is expanded as shown below<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre132" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image126.png"/><br class="calibre2"/> </li>
<li class="block_15">Click on <b class="calibre6">Expand condition</b><br class="calibre2"/> </li>
<li class="block_15">In the first field <i class="calibre7">Choose a value</i>, from the <i class="calibre7">Dynamic content</i> menu choose <b class="calibre6">selectedOption</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre133" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image127.png"/><br class="calibre2"/> </li>
<li class="block_15">Leave the middle field as <i class="calibre7">is equal to</i> <br class="calibre2"/> </li>
<li class="block_15">Change the last field to <b class="calibre6">Approve holiday request</b> (this is manually typed in)<br class="calibre2"/> </li>
<li class="block_15">The full condition is shown below<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre134" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image128.png"/><br class="calibre2"/> </li>
<li class="block_15">Lastly, we will need to populate the branches on the condition, within the <i class="calibre7">If yes</i> (green) branch click <b class="calibre6">Add an action<br class="calibre2"/> </b></li>
<li class="block_15">Search for <b class="calibre6">Team post</b><br class="calibre2"/> </li>
<li class="block_15">Select the action named <b class="calibre6">Post a message in a chat or channel</b><br class="calibre2"/><br class="calibre2"/><img alt="Text  Description automatically generated" class="calibre135" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-45.png"/><br class="calibre2"/> </li>
<li class="block_15">Configure the action as shown below, using dynamic content where necessary<br class="calibre2"/><br class="calibre2"/><img alt="Graphical user interface, text, application, email  Description automatically generated" class="calibre136" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-46.png"/><br class="calibre2"/> </li>
<li class="block_15">Click on the <b class="calibre6">ellipsis (…)</b> at the top-right of the <i class="calibre7">Post a message as the Flow bot to a user</i> action<br class="calibre2"/> </li>
<li class="block_15">Select <b class="calibre6">Copy to my clipboard</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre137" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image131.png"/><br class="calibre2"/> </li>
<li class="block_15">In the <i class="calibre7">If no</i> (red) branch click <b class="calibre6">Add an action</b><br class="calibre2"/> </li>
<li class="block_15">Click on the tab titled <i class="calibre7">My clipboard</i> below the search bar<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre138" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-47.png"/><br class="calibre2"/> </li>
<li class="block_15">Select your copied action<br class="calibre2"/><br class="calibre2"/><img alt="Graphical user interface, text  Description automatically generated" class="calibre139" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-48.png"/><br class="calibre2"/> </li>
<li class="block_15">Click on the new action to expand it and change the references from <i class="calibre7">approved</i> to <b class="calibre6">rejected</b> and add the <b class="calibre6">comments</b> property to the message<br class="calibre2"/><br class="calibre2"/><img alt="Graphical user interface, application  Description automatically generated" class="calibre140" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-49.png"/><br class="calibre2"/> </li>
<li class="block_15">At the top-right of the page click <b class="calibre6">Save</b><br class="calibre2"/> </li>
<li class="block_15">Once saved, close the <b class="calibre6">Power Automate</b> browser tab and the <b class="calibre6">SharePoint</b> browser tab, returning to the <i class="calibre7">Teams </i>browser tab with the list (you may need to click <b class="calibre6">Leave</b> to close the <i class="calibre7">Power Automate</i> tab)<br class="calibre2"/> </li>
<li class="block_25">In Teams, at the top-right of the list click on the <b class="calibre6">refresh</b> <img alt="Refresh" class="calibre141" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-50.png"/> icon</li>
</ol>
...
===
[Home](#home)
# Exercise 6 – Test the flow
<p class="block_">Now that the flow for approving holiday requests is ready, we will test it directly from Microsoft Teams.</p>
<ol class="list_">
<li class="block_30">In the <i class="calibre7">Holiday requests </i>list in the Marketing team’s <i class="calibre7">Holidays</i> channel, click on <b class="calibre6">+ New item</b><br class="calibre2"/> </li>
<li class="block_15">Complete the form with a test holiday event ensuring you have entered <b class="calibre6">your own name</b> as the <i class="calibre7">Line manager<br class="calibre2"/></i><br class="calibre2"/><img alt="Image" class="calibre142" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image137.png"/><br class="calibre2"/> </li>
<li class="block_15">Clicking <b class="calibre6">Save </b>will begin the flow, the first time a flow runs could mean that there is a 30 second delay before you receive your card<br class="calibre2"/> </li>
<li class="block_15">When you see a red badge appear in the left menu, click on the <b class="calibre6">Chat</b> button<br class="calibre2"/><br class="calibre2"/><img alt="Graphical user interface, application  Description automatically generated" class="calibre143" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image-51.png"/><br class="calibre2"/> </li>
<li class="block_15">Review the card from the Flow bot, choose to either <b class="calibre6">Approve holiday request </b>or <b class="calibre6">Reject holiday request</b><br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre144" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image139.png"/><br class="calibre2"/> </li>
<li class="block_15">Optionally enter any comments (which could be displayed to the requestee if we chose to reject the request)<br class="calibre2"/> </li>
<li class="block_15">Click <b class="calibre6">Submit</b><br class="calibre2"/> </li>
<li class="block_15">You will see that the requestee will receive a card from the Flow bot informing them of the outcome<br class="calibre2"/><br class="calibre2"/><img alt="Image" class="calibre145" src="https://raw.githubusercontent.com/WebucatorTraining/skillable/main/55302/epub/images/image140.png"/><br class="calibre2"/> </li>
<li class="block_21">You have successfully built and tested a flow that weaves the list that is already accessible in teams with its engaging chat functionality creating a seamless experience, well done!<br class="calibre2"/><br class="calibre2"/> </li>
</ol>
<p class="block_1"> </p>